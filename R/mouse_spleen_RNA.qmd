...
p34a <- plot_fov_w_markers(sobj_spleen_split2, 258, c("Cdkn1a","Lmna", "Mki67"), c("cyan", "red", "magenta"), "34Hom_Sene")
p34_1 <- plot_fov_w_markers(sobj_spleen_split2, 258, c("Cdkn1a"), c("cyan"), "34Hom_Cdkn1a")
p34_2 <- plot_fov_w_markers(sobj_spleen_split2, 258, c("Lmna"), c("red"), "34Hom_Lmna")
p34_3 <- plot_fov_w_markers(sobj_spleen_split2, 258, c("Mki67"), c("magenta"), "34Hom_Mki67")


p32a <- plot_fov_w_markers(sobj_spleen_split2, 268, c("Cdkn1a","Lmna", "Mki67"), c("cyan", "red", "magenta"), "32Het_Sene")
p32_1 <- plot_fov_w_markers(sobj_spleen_split2, 268, c("Cdkn1a"), c("cyan"), "32Het_Cdkn1a")
p32_2 <- plot_fov_w_markers(sobj_spleen_split2, 268, c("Lmna"), c("red"), "32Het_Lmna")
p32_3 <- plot_fov_w_markers(sobj_spleen_split2, 268, c("Mki67"), c("magenta"), "32Het_Mki67")

p30a <- plot_fov_w_markers(sobj_spleen_split2, 281, c("Cdkn1a","Lmna", "Mki67"), c("cyan", "red", "magenta"), "30WT_Sene")
p30_1 <- plot_fov_w_markers(sobj_spleen_split2, 281, c("Cdkn1a"), c("cyan"), "30WT_Cdkn1a")
p30_2 <- plot_fov_w_markers(sobj_spleen_split2, 281, c("Lmna"), c("red"), "30WT_Lmna")
p30_3 <- plot_fov_w_markers(sobj_spleen_split2, 281, c("Mki67"), c("magenta"), "30WT_Mki67")

# to keep scaling, patchwork them 
...
ggsave(paste0(results_dir, "/Spatial_3fovs__Lmna_only.png"), (p34_2 + p32_2 + p30_2), dpi=600, height=6, width=20)
